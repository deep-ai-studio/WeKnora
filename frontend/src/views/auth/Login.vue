<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left (hidden in simple mode) -->
    <a v-if="false" href="https://github.com/Tencent/WeKnora" target="_blank" class="header-logo" :title="$t('common.github')">
      <img src="@/assets/img/weknora.png" alt="WeKnora" class="logo-image" />
    </a>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a v-if="false" href="https://weknora.weixin.qq.com" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a v-if="false" href="https://github.com/Tencent/WeKnora" target="_blank" class="header-link" :title="$t('common.info')">
